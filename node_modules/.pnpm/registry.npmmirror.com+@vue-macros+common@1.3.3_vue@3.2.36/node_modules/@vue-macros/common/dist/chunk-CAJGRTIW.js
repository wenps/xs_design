...
function babelParse(code, lang, options = {}) {
  ...
  if (_chunkQGPQPPMMjs.isTs.call(void 0, lang)) {
    plugins.push(["typescript", { dts: lang === "dts" }]);
    if (_chunkAXNY6RSYjs.REGEX_LANG_JSX.test(lang))
      plugins.push("jsx");
...
function importHelperFn(s, offset, local, from = "vue", isDefault = false) {
  ...
  if (!((_a = importedMap.get(s)) == null ? void 0 : _a.has(cacheKey))) {
    s.appendLeft(
      offset,
      `
